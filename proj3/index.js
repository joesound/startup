...
//   window.onmousewheel = debounce(MouseWheel);}
  // } else if ('onmousewheel' in document) {
  //   document.onmousewheel = MouseWheel;
if ('addEventListener' in window) {
    window.addEventListener("mousewheel",debounce(MouseWheel) , false);
    window.addEventListener("DOMMouseScroll", debounce(MouseWheel), false);}
